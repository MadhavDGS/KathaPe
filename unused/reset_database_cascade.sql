...
-- This version uses CASCADE to drop all tables at once

-- ====================================================================
-- PART 1: DROP ALL EXISTING TABLES WITH CASCADE
-- ====================================================================
...
-- Drop all tables with CASCADE to handle dependencies automatically
